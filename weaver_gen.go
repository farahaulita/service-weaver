...
var _ func(_ context.Context, query string) string = (&cacheRouter{}).Get             // routed
var _ func(_ context.Context, query string, _ []string) string = (&cacheRouter{}).Put // routed
